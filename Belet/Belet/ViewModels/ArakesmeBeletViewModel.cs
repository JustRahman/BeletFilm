...
namespace Belet.ViewModels
{
    ...
    class ArakesmeBeletViewModel : ViewModelBase
    {
        ...
        public ArakesmeBeletViewModel()
        {
            ...
            arakesmeModel.geometry1 = System.AppDomain.CurrentDomain.BaseDirectory + @"Images\BeletLogo.png";

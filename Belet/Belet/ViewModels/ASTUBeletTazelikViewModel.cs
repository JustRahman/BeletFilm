...
namespace Belet.ViewModels
{
    ...
    class ASTUBeletTazelikViewModel : ViewModelBase
    {
        ...
        private ASTUBeletTazelikModel  _arakesmeModel;
        public ASTUBeletTazelikModel arakesmeModel
        {
            get
            {
        ...
        public ASTUBeletTazelikViewModel()
        {
            ...
            arakesmeModel = new ASTUBeletTazelikModel();

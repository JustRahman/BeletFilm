...
namespace Belet.ViewModels
{
    ...
    class TunerBeletViewModel : ViewModelBase
    {
        ...
        private TunerBeletModel _tunerBeletModel;
        public TunerBeletModel tunerBeletModel
        {
            get
            {
                return _tunerBeletModel;
            }
            set
            {
                SetValue(ref _tunerBeletModel, value);
            }
        }
        ...
        public TunerBeletViewModel()
        {
            ...
            tunerBeletModel = new TunerBeletModel();
            ...
            tunerBeletModel.firstimg = System.AppDomain.CurrentDomain.BaseDirectory + @"Images\BeletIpTuner.png";
            tunerBeletModel.geometry1 = System.AppDomain.CurrentDomain.BaseDirectory + @"Images\BeletLogo.png";


            tunerBeletModel.IsBigOrNormal = "Big Mode";
            tunerBeletModel.brush5 = "Black";
        ...
        private void sizechangebtn_cmd(object klop)
        {
            if (wndstate == false)
            {
                ...
                wndstate = true;
                tunerBeletModel.IsBigOrNormal = "Normal Mode";

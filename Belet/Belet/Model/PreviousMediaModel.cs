...
{
    class PreviousMediaModel : ViewModelBase
    {
        private string _harrypotter;
        public string harrypotter
        {
            ...
            set
            {
                SetValue(ref _harrypotter, value);
            }
        }
        ...
        public string anime
        {
            ...
            set
            {
                SetValue(ref _anime, value);
            }
        }

        private string _mandalor;
        public string mandalor
        {
            get
            {
                return _mandalor;
            ...
            set
            {
                SetValue(ref _mandalor, value);
            }
        }

        private string _hunterghost;
        public string hunterghost
        {
            get
            {
                return _hunterghost;
            ...
            set
            {
                SetValue(ref _hunterghost, value);
            }
        }
        ...
        public string videomedia
        {
            ...
            set
            {
                SetValue(ref _videomedia, value);
            }
        }

...
{
    class GineliyenBeletModel : ViewModelBase
    {
        ...
        public string firstimg
        {
            ...
            set
            {
                SetValue(ref _firstimg, value);
            }
        }
        private string _widthfirsty;
        public string widthfirsty
        {
            get
            {
                return _widthfirsty;
            ...
            set
            {
                SetValue(ref _widthfirsty, value);
            }
        }

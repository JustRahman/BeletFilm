...
{
    class LogginPasswordModel : ViewModelBase
    {

        private string _telekomimage;
        public string telekomimage
        {
            get
            {
                return _telekomimage;
            }
            set
            {
                SetValue(ref _telekomimage, value);
            }
        }

        private string _sectextvis;
        public string sectextvis
        {
            get
            {
                return _sectextvis;
            ...
            set
            {
                SetValue(ref _sectextvis, value);
            }
        }

        private string _Beletlogo;
        public string Beletlogo
        {
            get
            {
                return _Beletlogo;
        ...
        private string _firstxt;
        public string firstxt
        {
            get
            {
                return _firstxt;
            ...
            set
            {
                SetValue(ref _firstxt, value);
            }
        }

        private string _secstxt;
        public string secstxt
        {
            get
            {
                return _secstxt;
        ...
        public bool checker
        {
            ...
            set
            {
                SetValue(ref _checker , value);
            }
        }

        private string _secondimg;
        public string secondimg
        {
            ...
            set
            {
                SetValue(ref _secondimg, value);
            }
        }
        private string _thirtimg;
        public string thirtimg
        {
            get
            {
                return _thirtimg;
            ...
            set
            {
                SetValue(ref _thirtimg, value);
            }
        }

        private string _forthimg;
        public string forthimg
        {
            get
            {
                return _forthimg;
            ...
            set
            {
                SetValue(ref _forthimg, value);
            }
        }

        private string _fifthimg;
